...
def display_name # We want to display the ATC category usually, but some drugs in the HCDB do not have tc_atc_numbers, therefore we should display the Brand Names.
